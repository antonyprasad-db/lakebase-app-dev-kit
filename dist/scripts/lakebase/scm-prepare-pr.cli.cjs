...
var scm_prepare_pr_cli_exports = {};
__export(scm_prepare_pr_cli_exports, {
  runScmPreparePrCli: () => runScmPreparePrCli
});
module.exports = __toCommonJS(scm_prepare_pr_cli_exports);
