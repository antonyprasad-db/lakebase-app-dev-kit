...
from app.repositories.stock_repository import upsert_stock_record, get_stock_record, get_stock_records_by_location, get_stock_records_by_sku
...
def list_stock_by_sku(db, sku: str) -> list[dict]:
