...
# The home stock table reads the full collection from /stock (NFR-F1-5/-F1-7).
stock_collection_router = APIRouter(tags=["stock"])


@stock_collection_router.get("/stock")
def get_stock():
    return list_stock_records()
