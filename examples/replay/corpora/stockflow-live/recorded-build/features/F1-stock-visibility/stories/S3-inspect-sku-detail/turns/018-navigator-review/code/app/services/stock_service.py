...
class StockService:
    ...
    def list_stock_records(self, location: str | None = None) -> list[StockRecord]:
        return self._repository.list_all(location=location)

    def list_stock_records_for_sku(self, sku: str) -> list[StockRecord]:
        return self._repository.list_by_sku(sku)
