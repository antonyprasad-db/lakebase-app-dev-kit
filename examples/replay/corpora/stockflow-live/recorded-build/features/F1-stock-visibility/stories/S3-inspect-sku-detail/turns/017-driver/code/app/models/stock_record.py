...
carrying the quantity on hand and the inventory_code lot/batch reference.
created_at and actor are audit fields set by the service and stored
immutably by the model (never updated after insert) per R1.
"""
