...
def the_probe_reports_a_nonconforming_count(nonconforming_count, count):
    ...
    assert nonconforming_count == count, (
        f"expected a nonconforming count of {count}, got {nonconforming_count!r}"
    )
