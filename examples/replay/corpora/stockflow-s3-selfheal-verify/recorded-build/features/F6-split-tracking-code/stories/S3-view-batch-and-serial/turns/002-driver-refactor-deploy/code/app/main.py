...
from app.routes.stock_records import router as stock_records_router

app = FastAPI(title="stockflow-live-cap-20260709-191642", version="0.1.0")

app.include_router(stock_records_router)
